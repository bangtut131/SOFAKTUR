...
async function test() {
    console.log("--- NTT RAW DATA ---");
    const url = new URL(`${host}/sales-invoice/list.do`);
    url.searchParams.append('fields', 'id,number,transDate,totalAmount,primeOwing,outstanding,balance,remainAmount');
    ...
    console.log("NTT RAW:", JSON.stringify(data.d, null, 2));
}
test();
