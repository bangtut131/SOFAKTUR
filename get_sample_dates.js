...
async function test() {
    ...
    url.searchParams.append('fields', 'id,number,transDate,totalAmount,primeOwing');
    ...
    url.searchParams.append('sp.pageSize', '20');
    url.searchParams.append('sp.sort', 'transDate|asc');
    ...
    console.log("Sample Data:", JSON.stringify(data.d, null, 2));
}
test();
