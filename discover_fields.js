...
async function test() {
    ...
    // EXTENSIVE FIELD LIST
    url.searchParams.append('fields', 'id,number,transDate,date,totalAmount,amount,primeOwing,outstanding,balance,remainAmount');
    ...
    url.searchParams.append('sp.pageSize', '3');
    ...
    console.log("FIELDS DISCOVERY:", JSON.stringify(data.d, null, 2));
}
test();
