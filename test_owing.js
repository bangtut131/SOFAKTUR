...
async function test(useOwingStatus) {
    console.log(`--- Testing useOwingStatus: ${useOwingStatus} ---`);
    ...
    console.log(`   Data length: ${data.d?.length}, Total Count: ${data.sp?.totalCount}`);
}
